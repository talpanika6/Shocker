...
public class UserSendSelectFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ImageView done;
        Toolbar sendSelectLayout;

        // Inflate the layout for this fragment
        View v =  inflater.inflate(R.layout.fragment_user_send_select, container, false);

        //create hash
        hash=new HashMap<Integer,ParseUser>();

        //done
        done=(ImageView)v.findViewById(R.id.done_select);
        ...
        sendSelectLayout = (Toolbar) v.findViewById(R.id.sendSelectLayout);
        ///set backlistener
        sendSelectLayout.setTitle(getString(R.string.select));
        sendSelectLayout.setTitleTextColor(getResources().getColor(R.color.white));
        sendSelectLayout.setNavigationIcon(getResources().getDrawable(R.drawable.ic_arrow_back_white_18dp));
        sendSelectLayout.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                BackTo();
            }
        ...
        progress=(ProgressWheel)v.findViewById(R.id.progressSelect);
        ...
        friendsAdapter = new SendAdapter(new ArrayList<ParseUser>(), R.layout.item_list_friends_select,this);
    ...
    private void SaveToDb() {
        ...
        List<PhotoShare> share = new ArrayList<>();
        ...
        String notificationText = "You Shocked by " + ParseUser.getCurrentUser().getUsername();
        JSONObject obj = null;
    ...
    private void BackTo()
    {
        ...
        fm.popBackStack("SelectFragment",
